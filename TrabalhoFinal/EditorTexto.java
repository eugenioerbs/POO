...
public class EditorTexto extends javax.swing.JFrame {
    ...
    private void abrirArquivo () {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            StyledDocument doc = new ArquivoBinario().abrirArquivo(file);
            
            if (doc != null) {
                jblPainel.setStyledDocument(doc);
            } else {
    ...
    private void salvarArquivo () {   
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            new ArquivoBinario().salvarArquivo(file, doc);
    ...
    private void jblColorirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jblColorirActionPerformed
        ...
        if (cor.equalsIgnoreCase("vermelho")) {
           mudarCorTexto(Color.red);
            ...
            mudarCorTexto(Color.pink);
        } else if (cor.equalsIgnoreCase("preto")) {
            mudarCorTexto(Color.black);
        }
